...
sgtitle(['Wilcoxon signed-rank test for RP [Hits vs Misses] / Grand Average'], 'Color',"k", 'Fontweight', 'bold'); % Super title
...
% saveas(gcf, [outpath, 'topo_stats_conditions_grand_avg', '.png']); % Save the figure as a PNG image
% saveas(gcf, [outpath, '\\group_analysis\\','topo_stats_conditions_grand_avg', '.png']); % Save the figure as a PNG image

save([outpath, 'topo_stats_conditions_grand_avg', '.mat'], 'pValues_Table');
% save([outpath, 'topo_stats_conditions_grand_avg_labels', '.mat'], 'testLabels_Table', 'normality_p_values_hits',...
%     'normality_p_values_misses', 'levenes_p_values');

save_fig(gcf, [outpath, '\\group_analysis\\'], ['topo_stats_conditions_grand_avg'], ...
        'fontsize', 14, ...
        'figsize', [35, 20], ...
        'figtypes', {'.png'},...
        'dpi', 600);
