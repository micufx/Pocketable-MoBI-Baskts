...
for cond=3 : num_conditions
    ...
    binEdges = [-2500, -2400, -2300, -2200, -2100, -2000, -1900, -1800, -1700, -1600, -1500, -1400, -1300, -1200, -1100, -1000];
    ...
    for itopo = 1 : nBins
        ...
        if itopo == 1
            timeEEG = [find(EEG.times == -2500) : find(EEG.times == -2400)];
        elseif itopo == 2
            timeEEG = [find(EEG.times == -2400) : find(EEG.times == -2300)];
        elseif itopo == 3
            timeEEG = [find(EEG.times == -2300) : find(EEG.times == -2200)];
        elseif itopo == 4
            timeEEG = [find(EEG.times == -2200) : find(EEG.times == -2100)];
        elseif itopo == 5
            timeEEG = [find(EEG.times == -2100) : find(EEG.times == -2000)];
        elseif itopo == 6
            timeEEG = [find(EEG.times == -2000) : find(EEG.times == -1900)];
        elseif itopo == 7
            timeEEG = [find(EEG.times == -1900) : find(EEG.times == -1800)];
        elseif itopo == 8
            timeEEG = [find(EEG.times == -1800) : find(EEG.times == -1700)];
        elseif itopo == 9
            timeEEG = [find(EEG.times == -1700) : find(EEG.times == -1600)];
        elseif itopo == 10
            timeEEG = [find(EEG.times == -1600) : find(EEG.times == -1500)];
        elseif itopo == 11
            timeEEG = [find(EEG.times == -1500) : find(EEG.times == -1400)];
        elseif itopo == 12
            timeEEG = [find(EEG.times == -1400) : find(EEG.times == -1300)];
        elseif itopo == 13
            timeEEG = [find(EEG.times == -1300) : find(EEG.times == -1200)];
        elseif itopo == 14
            timeEEG = [find(EEG.times == -1200) : find(EEG.times == -1100)];
        elseif itopo == 15
            timeEEG = [find(EEG.times == -1100) : find(EEG.times == -1000)];
        end
    ...
    if cond == 1
        ...
        saveas(gcf, [outpath, '\\group_analysis\\', 'Motion_grand_avg_hit_alltopo_02', '.jpg']); % Save the figure as a PNG image
    ...
    elseif cond ==2
        ...
        saveas(gcf, [outpath, '\\group_analysis\\','Motion_grand_avg_miss_alltopo_02', '.jpg']); % Save the figure as a PNG image
    ...
    elseif cond == 3
        ...
        saveas(gcf, [outpath, '\\group_analysis\\','Motion_grand_avg_alltopo_02', '.jpg']); % Save the figure as a PNG image

        save_fig(gcf,[outpath, '\\group_analysis\\',], 'Motion_grand_avg_alltopo_02',...
        'fontsize', 8, ...
        'figsize', [35, 20], ...
        'figtypes', {'.png'},...
        'dpi', 600);
