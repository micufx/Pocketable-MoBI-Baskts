...
for sub=1 : length(files)
    ...
    shoot_per = (T.Hits{sub} * 100 ) / (T.Num_good_trials{sub});
...
for sub=1 : length(files)
    ...
    T.Num_bad_comp {sub}  = length (T.Bad_components{sub}  );
...
for f = 1:numFigures
    ...
    save_fig(figures{f},[outpath, '\\group_analysis\\',], ['Shooting_accuracy_topo_0', '_', num2str(f),],...
        'fontsize', 12, ...
        'figsize', [35, 20], ...
        'figtypes', {'.png'},...
        'dpi', 600);
